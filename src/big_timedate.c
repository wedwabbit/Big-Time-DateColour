...
#define NUMBER_OF_IMAGES 20 // Total number of images across all fonts.
...
const int IMAGE_RESOURCE_IDS[NUMBER_OF_IMAGES] = {
    ...
    RESOURCE_ID_IMAGE_NUM_0_BA, RESOURCE_ID_IMAGE_NUM_1_BA, RESOURCE_ID_IMAGE_NUM_2_BA,
    RESOURCE_ID_IMAGE_NUM_3_BA, RESOURCE_ID_IMAGE_NUM_4_BA, RESOURCE_ID_IMAGE_NUM_5_BA,
    RESOURCE_ID_IMAGE_NUM_6_BA, RESOURCE_ID_IMAGE_NUM_7_BA, RESOURCE_ID_IMAGE_NUM_8_BA,
    RESOURCE_ID_IMAGE_NUM_9_BA
};
